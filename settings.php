		        ...
		        <div class="accordion-group">
					...
					<div id="collapse1" class="accordion-body collapse">
				        ...
				        <?php 
					        ...
					        else if(get_user_data('ses_endpoint')=='email.ap-south-1.amazonaws.com') $endpoint_name = 'Mumbai';
					        else if(get_user_data('ses_endpoint')=='email.ap-southeast-2.amazonaws.com') $endpoint_name = 'Sydney';
					        else if(get_user_data('ses_endpoint')=='email.eu-central-1.amazonaws.com') $endpoint_name = 'Frankfurt';
				        ?>
			    		<select id="ses_endpoint" name="ses_endpoint">
						  ...
						  <option value="email.ap-south-1.amazonaws.com">Mumbai</option>
						  <option value="email.ap-southeast-2.amazonaws.com">Sydney</option>
						  <option value="email.eu-central-1.amazonaws.com">Frankfurt</option>
						  ...
						  <option value="email.ap-southeast-2.amazonaws.com">Sydney</option>
						  <option value="email.eu-central-1.amazonaws.com">Frankfurt</option>
						  <?php elseif($endpoint_name == 'Mumbai'):?>
						  <option value="email.us-east-1.amazonaws.com">N. Virginia</option> 
						  <option value="email.us-west-2.amazonaws.com">Oregon</option>
						  <option value="email.eu-west-1.amazonaws.com">Ireland</option>
						  <option value="email.ap-southeast-2.amazonaws.com">Sydney</option>
						  <option value="email.eu-central-1.amazonaws.com">Frankfurt</option>
						  <?php elseif($endpoint_name == 'Sydney'):?>
						  <option value="email.us-east-1.amazonaws.com">N. Virginia</option> 
						  <option value="email.us-west-2.amazonaws.com">Oregon</option>
						  <option value="email.eu-west-1.amazonaws.com">Ireland</option>
						  <option value="email.ap-south-1.amazonaws.com">Mumbai</option>
						  <option value="email.eu-central-1.amazonaws.com">Frankfurt</option>
						  <?php elseif($endpoint_name == 'Frankfurt'):?>
						  <option value="email.us-east-1.amazonaws.com">N. Virginia</option> 
						  <option value="email.us-west-2.amazonaws.com">Oregon</option>
						  <option value="email.eu-west-1.amazonaws.com">Ireland</option>
						  <option value="email.ap-south-1.amazonaws.com">Mumbai</option>
